...
(function(w){
    ...
    legend.prototype = {
        init: function(){
            ...
            element.style.cssText = "border-radius:5px;position:absolute;"+positionCss+"font-family:Helvetica; width:256px;z-index:-999; background:rgba(255,255,255,1);padding:10px;border:1px solid black;margin:0;display:none;";
    ...
    heatmap.prototype = {
        configure: function(config){
                ...
                me.set("gradient", config.gradient || { 0.45: "rgb(50,0,125)", 0.55: "rgb(45,80,150)", 0.65: "rgb(45,165,175)", 0.95: "blue", 1.0: "rgb(40,250,200)"});    // default is the common blue to red gradient
